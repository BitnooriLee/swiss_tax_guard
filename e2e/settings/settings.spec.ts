 ...
 * 2. Locale/language switching (English, German, French, Korean)
 * 
...
test.describe("Locale Switcher", () => {
  ...
  /**
   * Switches to German and verifies persisted `lang="de"`.
   */
  ...
  /**
   * Switches to French and verifies persisted `lang="fr"`.
   */
